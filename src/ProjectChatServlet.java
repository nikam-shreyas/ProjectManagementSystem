...
/**
 * Servlet implementation class ProjectChatServlet
 */
@WebServlet("/ProjectChatServlet")
public class ProjectChatServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ProjectChatServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String curr_user= request.getParameter("guide_id");
		String resp = "";
		...
		try {
			...
			RequestDispatcher rd =  
					request.getRequestDispatcher("ProjectChat.jsp"); 
